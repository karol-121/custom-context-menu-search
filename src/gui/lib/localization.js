...
const MESSAGE_INVALID_ITEM = "Invalid item!";
...
const MESSAGE_INVALID_HANDLING = "Provided action id is invalid! Valid id's are 1, 2 or 3";
const MESSAGE_NO_ID = "Missing object id!";
